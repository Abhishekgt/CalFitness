  ...
  return (
    <section id="home" className="w-[95vw] mx-auto md:w-full">
      <div className="flex flex-col mx-auto">
        <h1 className="w-full text-3xl mt-[25vh] text-white text-center font-bold mx-auto">Cal Fitness</h1>
        <p className="w-full text-md mt-2 mb-4 text-gray-400 text-center mx-auto">Your Personal Fitness Companion</p>
